...
def getStringByParams(params):
    ...
    for key in sorted(params.keys()):
        # value = params[key] if params[key] is not None and params[key].lower() != "null" else "" # produce error in the lower() function
        value = params[key] if params[key] is not None and params[key] != "null" else ""
